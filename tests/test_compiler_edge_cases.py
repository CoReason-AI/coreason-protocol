...
def test_compile_quotes_in_labels(empty_protocol: ProtocolDefinition) -> None:
    ...
    strategy = compiler.compile(empty_protocol)
...
def test_compile_boolean_keywords_in_labels(empty_protocol: ProtocolDefinition) -> None:
...
def test_compile_whitespace_trimming(empty_protocol: ProtocolDefinition) -> None:
...
def test_compile_block_ordering(empty_protocol: ProtocolDefinition) -> None:
...
def test_compile_missing_intermediate_blocks(empty_protocol: ProtocolDefinition) -> None:
    # P and O only
    t_p = OntologyTerm(id="p1", label="Patient", vocab_source="Other", code="P", origin=TermOrigin.USER_INPUT)
...
def test_compile_unicode_terms(empty_protocol: ProtocolDefinition) -> None:
...
def test_compile_many_terms(empty_protocol: ProtocolDefinition) -> None:
